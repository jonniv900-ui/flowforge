...
if not defined MSBUILD (
  ...
  echo Confirme tambem o Developer Pack do .NET Framework 4.8.
  pause
  exit /b 1
)

echo Compilando FlowForge Studio e FlowForge Education...
"%MSBUILD%" FlowForgeSuite.sln /t:Restore,Build /p:Configuration=Release /m
if errorlevel 1 (
  echo.
...
echo Studio:    FlowForgeStudio\bin\Release\FlowForgeStudio.exe
echo Education: FlowForgeEducation\bin\Release\FlowForgeEducation.exe
pause
