...
Namespace FlowForgeStudio
    ...
    <DefaultEvent("ContentChanged")> Public Class RichTextEditor
        ...
        Private ReadOnly fontNames As New ToolStripComboBox()
        ...
        Public Sub New()
            ...
            fontNames.Width = 125
            fontNames.Items.AddRange(New Object() {"Arial", "Calibri", "Consolas", "Segoe UI", "Times New Roman", "Verdana"})
            fontNames.Text = "Segoe UI"
            fontSizes.Width = 48
            fontSizes.Items.AddRange(New Object() {"8", "9", "10", "11", "12", "14", "16", "18", "24", "32", "48"})
            fontSizes.Text = "10"
            formatBar.Items.Add(fontNames)
