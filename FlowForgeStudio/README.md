# FlowForge Studio 0.39.1

IDE visual escrita inteiramente em VB.NET Windows Forms e direcionada ao .NET Framework 4.8. Os aplicativos criados também são VB.NET Windows Forms 4.8.

## Recursos

- `DigitalDisplay` gráfico com modos SevenSegment, DotMatrix e Text, sem depender de fontes externas.
- Novos controles nativos: CircularProgress, LevelMeter, BadgeLabel, SeparatorLine, StarRating, NumericKnob e CardPanel.
- Os controles customizados participam do Designer, PropertyGrid, autocompletar e do EXE gerado.
- Dez novos componentes para telemetria, indicadores animados, cores, notificações e navegação.
- Editor rico com barra de formatação e editor de código com sintaxe VB.NET/HTML/JSON, régua de linhas e proteção contra cintilação.
- Lista de até dez projetos recentes, com histórico separado da edição Education.
- Abertura de projetos `.flowapp` por arrastar e soltar sobre a janela.
